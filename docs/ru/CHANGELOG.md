...
- Версия расширения обновлена до **0.2.1**.
- Исправлена загрузка тем: меньше заметной светлой вспышки при обновлении страницы; изображения стабильнее подгружаются при смене тем и пресетов.
