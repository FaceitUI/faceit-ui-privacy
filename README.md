...
| [Политика конфиденциальности (Markdown)](docs/privacy/PRIVACY.md) | Та же политика в формате Markdown |
| [История изменений](docs/changelog/CHANGELOG.md) | Версии и заметные изменения |
| [Известные ограничения](docs/known-issues/KNOWN_ISSUES.md) | Подтверждённые наблюдения и ограничения |
...
**Текущая версия расширения:** 0.2.0 (см. [История изменений](docs/changelog/CHANGELOG.md)).
